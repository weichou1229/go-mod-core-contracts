...
type CommandClient interface {
	...
	IssueGetCommandByNameWithObject(ctx context.Context, deviceName string, commandName string, dsPushEvent string, dsReturnEvent string, settings map[string]interface{}) (*responses.EventResponse, errors.EdgeX)
